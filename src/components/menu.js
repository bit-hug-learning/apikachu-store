...
function Menu({ number }) {
  ...
  <header class="menu">
    <nav class="menu__nav">
      ...
      <ul class="menu__list">
        <li class="menu__item" ><span class="menu__icon"><img src=${UserIcon} alt="User icon" /></span><a class="menu__link" href="#">Sign In | Sign Up</a></li>
        <li class="menu__item" ><span class="menu__icon"><img src=${WishIcon} alt="Wish icon" /></span><a class="menu__link" href="#">My Wish List${number}</a></li>
        <li class="menu__item" ><span class="menu__icon"><img src=${BagIcon} alt="Bag icon" /></span><a class="menu__link" href="#">My Bag${number}</a></li>
        <li class="menu__item" ><a class="menu__link" href="#">Shop</a></li>
        <li class="menu__item" ><a class="menu__link" href="#">Hot sell</a></li>
      </ul>
